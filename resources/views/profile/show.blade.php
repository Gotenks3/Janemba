            ...
            <div class="px-6">
                <div class="flex flex-wrap justify-center">
                    ...
                    <div class="w-full px-4 flex justify-center">
                        <div class="relative">
                            <img src="{{ asset('storage/profiles/'  . $userProfile->icon) }}" alt="no-image" class="object-fill" style="border-radius: 50%; width: 200px; height: 200px;">
                        </div>
                    </div>
                ...
                <div class="text-center mt-6">
                    ...
                    <div class="mb-2 text-blueGray-600 mt-10">
                        ...
                        @if ($pref_id === $userProfile->prefecture)
                        {{ $name }}
                        @endif
                        @endforeach
                    </div>
                    <div class="mb-2 text-blueGray-600 mt-10">
                       ...
                       年齢: {{ $userProfile->age }}才
                    </div>
                    <div class="mb-2 text-blueGray-600">
                        <i class="fas fa-university mr-2 text-lg text-blueGray-400"></i>
                        性別: {{\App\Enums\GenderType::getDescription($userProfile->gender)}}
                    </div>
                </div>
