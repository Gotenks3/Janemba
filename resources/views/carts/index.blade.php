          ...
          <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
              <div class="p-6 bg-white border-b border-gray-200">
                  @if (count($products) > 0)
                    ...
                    <div>
                      <button onclick="location.href='{{ route('product.cart.checkout')}}'" class="flex px-6 py-2 ml-auto text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">購入する
                      </button>
                    </div>
                  @else
                    カートに商品が入っていません。
